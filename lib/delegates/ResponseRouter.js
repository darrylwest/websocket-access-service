...
var ResponseRouter = function(options) {
    ...
    this.openPrivateChannel = function(request, callback) {
        ...
        consumer.onMessage(function(msg) {
            ...
            if (msg.ssid !== ssid && action) {
                ...
                if (msg.message.action === 'authenticate') {
                    ...
                    dao.authenticate( msg.message, responseCallback );
                } else {
        ...
        if (!dao.calculateDigest) {
            log.info('calculateDigest is null so assign the message service calculator');
            dao.calculateDigest = consumer.calculateDigest;
        }
